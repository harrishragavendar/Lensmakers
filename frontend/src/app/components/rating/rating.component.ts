...
export class RatingComponent implements OnInit {
  ...
  ngOnInit() {
    if (this.rating > 4.5) {
      ...
      this.ratings = ['star', 'star', 'star_half', 'star_outline', 'star_outline'];
    }
    else if (this.rating > 1.5) {
      this.ratings = ['star', 'star', 'star_outline', 'star_outline', 'star_outline'];
    }
    else if (this.rating > 1) {
      this.ratings = ['star', 'star_half', 'star_outline', 'star_outline', 'star_outline'];
    }
    else if (this.rating > 0.5) {
      this.ratings = ['star', 'star_outline', 'star_outline', 'star_outline', 'star_outline'];
    }
    else if (this.rating > 0) {
      this.ratings = ['star_half', 'star_outline', 'star_outline', 'star_outline', 'star_outline'];
    }
  }
}
